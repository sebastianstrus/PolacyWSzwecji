...
extension UIColor {
    ...
    class var lightRed: UIColor { return UIColor(r: 240, g: 30, b: 30)}
    class var sideMenuTint: UIColor { return UIColor.lightRed } //.white
    ...
    class var sideMenuBackground: UIColor { return UIColor.white}
